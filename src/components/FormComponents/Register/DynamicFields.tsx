...
const DynamicFields: React.FC<DynamicFieldsProps> = ({ userType, handleChange, formData, handleOnSubmit,handleForm }) => {
    ...
    return (
        <div className=' w-[400px] mx-auto flex flex-col gap-2 text-[18px] mt-[1%] justify-center'>
            ...
            <button type="button" className='px-[17px] py-[10px] bg-[--primary-purpel] text-white flex flex-row items-center gap-5 justify-center hover:shadow-lg my-[2%] w-[400px] mx-auto' onClick={()=>handleSubmit(true)}>Register to Your Account <ArrowIcon /></button>
