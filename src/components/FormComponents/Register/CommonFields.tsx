...
const CommonFields: React.FC<CommonFieldsProps> = ({ handleChange, formData, handleForm, onHandleErrors }) => {
  ...
  const validateFields = () => {
    ...
    if (!formData.confirmPassword) validationErrors.confirmPassword = "Confirm password";
    if (formData.password !== formData.confirmPassword) validationErrors.confirmPassword = "Both Password & ConfirmPassword is not Match";
